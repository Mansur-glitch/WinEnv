...
namespace winenv
{
  ...
  class WinConsole
  {
    ...
    void resize_chrs(short width, short height, short buf_width = 0, short buf_height = 0);
    ...
    // Позволяет в дочернем процессе оконной программы получить консоль того же вида,
    // как если бы программа была консольной 
