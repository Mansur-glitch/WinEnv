...
namespace winenv
{
  ...
  {
    LogWindowFields(std::string text = {}, std::string font_name = {}, size_t font_size = {});
    ~LogWindowFields();
  ...
  class LogWindow : private LogWindowFields, virtual public EventDriven,
                    public BorderlessWindow, public HiddenWindow
  {
    public:
