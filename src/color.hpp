...
constexpr DWORD console_text_attribute(ConsoleColor foreground, ConsoleColor background)
{
...
class RgbColor
{
    ...
    constexpr RgbColor(Channel red = 0, Channel green = 0, Channel blue = 0) noexcept
    // В windows младший байт - синий, старший - красный, т.е. обратный порядок 
