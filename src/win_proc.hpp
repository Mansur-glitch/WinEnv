...
class WinProcess
{
    ...
    class Constructor
    {
        ...
        // Если exe_path == {}, тогда первый аргумент используется как путь к .exe файлу
        ...
        // Допустимые флаги: https://learn.microsoft.com/en-us/windows/win32/procthread/process-creation-flags
        ...
        Constructor& set_console_color(ConsoleColor foreground, ConsoleColor background) noexcept;
